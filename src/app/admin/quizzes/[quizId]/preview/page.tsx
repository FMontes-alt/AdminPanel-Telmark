...
export default function AdminQuizPreviewPage() {
    ...
    // Effect to resolve media URL when question changes
    useEffect(() => {
            ...
            <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 to-blue-50/30 p-4">
                ...
                >
                    <div className="bg-gradient-to-r from-blue-600 to-blue-700 p-8 text-white text-center flex gap-2 flex-col items-center">
                        <span className="px-3 py-1 bg-white/20 rounded-full text-[10px] font-black tracking-widest uppercase">Modo Prueba (Admin)</span>
                    ...
                    <div className="p-8 space-y-6">
                        ...
                        >
                            <ChevronLeft size={14} /> Volver a Edición
                        </button>
                    </div>
                </motion.div>
            </div>
        ...
        <div className="h-[calc(100vh-80px)] bg-gradient-to-br from-slate-50 to-blue-50/30 flex flex-col rounded-[32px] overflow-hidden border border-slate-200 shadow-xl">
            ...
            <div className="bg-white border-b border-slate-100 px-6 py-3 flex items-center justify-between sticky top-0 z-10">
                <div className="flex items-center gap-4">
                    <button onClick={() => router.push(`/admin/quizzes/${quizId}`)} className="mr-2 text-slate-400 hover:text-slate-700">
                        <XCircle size={20} />
                    </button>
