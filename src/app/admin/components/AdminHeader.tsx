...
export function AdminHeader() {
    ...
    return (
        <header className="h-16 bg-white/70 backdrop-blur-md border-b border-slate-200 sticky top-0 z-10 px-6 flex items-center justify-between">
            <div className="flex items-center gap-4 flex-1">
                <div className="relative max-w-sm w-full hidden lg:block">
                    ...
                    <input 
                        ...
                        className="w-full bg-slate-100 border-none rounded-full py-1.5 pl-10 pr-4 text-xs focus:ring-2 focus:ring-blue-500/20 transition-all"
                    />
                </div>
            </div>
